...
const GlobalPresenceSection: React.FC = () => {
  return (
    <section id="market_served" className="bg-white py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Trusted pharmaceutical partner serving healthcare markets across
            three continents.
          </p>
        </div>
        ...
        <div
          className="bg-gray-50 rounded-xl shadow-lg border border-gray-100 

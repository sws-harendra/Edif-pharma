        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-2 bg-white h-full rounded-lg shadow-lg border border-gray-200 p-8">
            ...
            <p className="mt-4 text-base text-gray-600">
              The new state-of-the-art facility will increase our production capacity by 40% and 
              create 200 new jobs, strengthening our commitment to serving growing Asian 
              markets with quality pharmaceutical products.
            </p>
          ...
          <div className="lg:col-span-1 space-y-5">
            ...
            <div className="space-y-4">
              {featuredIn.map((item) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-blue-800 text-white 

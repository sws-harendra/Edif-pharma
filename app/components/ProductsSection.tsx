...
const productsData: ProductCardData[] = [
  {
    ...
    title: "APIs",
    description:
      "High-quality Active Pharmaceutical Ingredients manufactured under stringent quality standards.",
    href: "/products/apis",
    buttonType: "filled",
  },
  {
    ...
    description:
      "Complete pharmaceutical formulations ready for market distribution worldwide.",
  ...
  },
  {
    ...
    description:
      "Custom pharmaceutical solutions tailored to specific therapeutic needs and markets.",
  ...
  },
  {
    ...
    description:
      "End-to-end manufacturing services from development to commercial production.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Comprehensive pharmaceutical solutions backed by decades of
            expertise and global regulatory compliance.
          </p>
        </div>

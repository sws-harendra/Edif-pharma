...
const testimonials: TestimonialCardData[] = [
  {
    rating: 5,
    quote:
      "PharmaGlobal has been our reliable partner for consistent quality and timely delivery across multiple markets. Their commitment to excellence is unmatched.",
  ...
  },
  {
    rating: 5,
    quote:
      "The regulatory compliance and documentation provided by PharmaGlobal made our market entry seamless across 15 countries.",
  ...
  },
  {
    rating: 5,
    quote:
      "Their R&D capabilities and custom formulation services have helped us bring innovative products to market faster than ever before.",
...
const TestimonialsSection: React.FC = () => {
  return (
    <section id="testimonial" className="bg-gray-50 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Our partnerships speak to our commitment to quality, reliability,
